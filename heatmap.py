...
data = pd.read_csv('qrng.csv')
print(data)

# Plot the heatmap
heatmap_plot = sns.heatmap(data, cmap="binary_r")
# ax = sns.kdeplot(data)
...
plt.show()
 ...
 # 'turbo_r', 'twilight', 'twilight_r', 'twilight_shifted', 'twilight_shifted_r', 'viridis', 'viridis_r', 'vlag',\
